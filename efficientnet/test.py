...
parser.add_argument('--data-root', type=str,
                    default='/eva_data/zchin/2021VRDL_HW1_datasets', help='data root dir')
...
parser.add_argument('--img-size', type=int, default=380,
                    help='image size in model')
parser.add_argument('--num-classes', type=int,
                    default=200, help='number of classes')
parser.add_argument('--net', type=str,
                    default="efficientnet-b4", help="which model")
parser.add_argument('--gpu', type=int, default=2, help='gpu id')
parser.add_argument('--savedir', type=str,
                    default='/eva_data/zchin/rsna_data_all/images/test_detect')
parser.add_argument('--thres', type=float, default=0.2,
                    help='classfication probability threshold')
...
if __name__ == "__main__":
    with open(os.path.join(args.data_root, 'test.txt')) as f:
        test_images = [x.strip()
                       for x in f.readlines()]  # all the testing images
    ...
    test(test_images, args.ckpt, args.img_size, args.net,
         args.gpu, args.num_classes, args.data_root)
